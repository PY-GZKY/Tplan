...
class DictData(Base):
    ...
    # meta
    css_class = Column(String(128), default=None, doc="css样式")
    list_class = Column(String(128), default=None, doc="表格样式")
...
class Menu(Base):
    ...
    component = Column(Text, doc="组件", default="")
    ...
    order = Column(Integer, doc="排序")
    parent_id = Column(Integer, ForeignKey("menu.id", ondelete='CASCADE'), index=True,nullable=True)  # ondelete='CASCADE' 联级删除
